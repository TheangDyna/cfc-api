...
const getDetailCommunity = async (req, res) => {
    ...
    try {
        ...
        //find event id
        const findId = await db.communities.findById(communityId).populate({ path: "createBy", select: 'firstName lastName profile' }, { path: "userId", select: 'firstName lastName profile' });
